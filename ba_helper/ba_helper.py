...
def main():
    ...
    while not is_feature_folder_find:
        filepath_feature = input("Veuillez préciser le chemin du dossier racine contenant les fichiers .features : ")
        is_feature_folder_find =  custom_tools.check_folder(filepath_feature)
    while not is_step_folder_find:
        filepath_steps = input("Veuillez préciser le chemin du dossier racine contenant les fichiers java : ")
